    ...
    >
      ...
      <a-form :form="infoForm">
        ...
        <a-form-item
          ...
          label="type"
        >
          <a-input placeholder="解析类型" v-model="infoParams.type" id="domain_type"/>
        </a-form-item>
        ...
        <a-form-item
          ...
          hasFeedback
        >
          <a-textarea placeholder="信息Json" autosize v-model="infoParams.info" id="domain_info"/>
        </a-form-item>
      </a-form>
    </a-modal>
  </a-card>
